...
function hostPrepareGame(gameId) {
    ...
    debug("All Players Present. Preparing game...");
...
function sendWord(wordPoolIndex, gameId) {
    getSpotifyData(function (data) {
        data = _.defaults(data, { round: wordPoolIndex, word: 'Name the artist' });
        io.sockets.in(gameId).emit('newWordData', data);
    });
}

function getSpotifyData (clb) {
    spotify.getQuestion(clb);
}
